...
namespace Butcher_shop
{
    public partial class UpdateProductForm : Form
    {
        ...
        private void ApplyStylesAndLayout()
        {
            ...
            // 3. Setup Inputs Layout (Aligning labels to the left of textboxes)
            ...
            btnUpdate.BackColor = primaryOrange;
            btnUpdate.ForeColor = Color.White;
            StyleAsModernButton(btnUpdate);
        ...
        private void PositionButtons()
        {
            ...
            {
                int spacing = 20;
                int totalBtnWidth = btnUpdate.Width + spacing + btnCancel.Width;
                int startX = (this.Width - totalBtnWidth) / 2;
                int btnY = this.Height - 70;

                btnUpdate.Location = new Point(startX, btnY);
                btnCancel.Location = new Point(startX + btnUpdate.Width + spacing, btnY);
            }
        }
