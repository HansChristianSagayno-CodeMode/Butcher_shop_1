...
namespace ButcherShopSystem
{
    public partial class AddEmployeeForm : Form
    {
        ...
        private void ApplyStylesAndLayout()
        {
            ...
            Label[] labels = { lblOwner, lblName, lblContact, lblRole };
            TextBox[] textboxes = { txtOwnerID, txtEmployeeName, txtContact, txtRole };
            string[] labelTexts = { "Owner ID:", "Employee Name:", "Contact:", "Role:" };

            int startY = 70; // Started a bit lower to accommodate the title
            int leftMargin = 40;
            int rightMargin = 40;
