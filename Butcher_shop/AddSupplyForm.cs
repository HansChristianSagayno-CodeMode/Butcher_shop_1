...
namespace Butcher_shop
{
    public partial class AddSupplyForm : Form
    {
        ...
        private void ApplyStylesAndLayout()
        {
            ...
            Label[] labels = { lblSupplier, lblProduct, lblCost, lblQty };
            Control[] inputs = { cmbSupplier, cmbProduct, txtCost, txtQuantity };
            string[] labelTexts = { "Supplier:", "Product:", "Unit Cost:", "Quantity:" };
